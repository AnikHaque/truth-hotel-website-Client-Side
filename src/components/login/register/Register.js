...
<h1 className="fw-bold text-center">Please Register</h1>
 ...
 <form className="bg-primary text-white p-5 mb-5" onSubmit={handleLoginSubmit}>
    <TextField 
    sx={{width:'75%', m:1}}
    name="email"
    id="standard-basic" 
...
<Button onClick={handleGoogleSignIn} variant="contained" className='mb-5'>Sign In With Google</Button>
